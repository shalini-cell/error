...
function [prod] = array_8_rcpfa_8(input1,input2)
    ...
    %  FINAL(1,31)=xor(B(1,16),A(1,16));
     ...
     C(1,8)=f7;
      ...
      f1=~(S(1,3)&P(3,1));
      C(2,9)=f7;
      [S(2,9),C(2,8)]=RA(S(1,9),P(3,7),C(2,9),f6);
   ...
   %disp(C(2,18));
      ...
      f1=~(S(2,4)&P(4,1));
      C(3,9)=f6;
      [S(3,9),C(3,8)]=RA(S(2,9),P(4,6),C(3,9),f5);
    ...
    %%
      ...
      %for i=1:13
       ...
       f1=~(S(3,5)&P(5,1));
      C(4,9)=f5;
       [S(4,9),C(4,8)]=RA(S(3,9),P(5,5),C(4,9),f4);
     ...
     f4=~(S(4,9)&P(6,4));
     C(5,9)=f4;
     [S(5,9),C(5,8)]=RA(S(4,9),P(6,4),C(5,9),f3);
     ...
     f3=(S(5,9)&P(7,3));
     C(6,9)=f3;
     [S(6,9),C(6,8)]=RA(S(5,9),P(7,3),C(6,9),f2);
     ...
     f2=~(S(6,9)&P(8,2));
     C(7,9)=f2;
     [S(7,9),C(7,8)]=RA(S(6,9),P(8,2),C(7,9),f1);
